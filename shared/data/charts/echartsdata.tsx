...
export const Stackoption = {
    ...
    color: ["rgb(121, 97, 245)", "rgb(227, 84, 212)", "rgb(255, 93, 159)", "rgb(255, 93, 159)", "rgb(254, 84, 84)"]
};
...
export const Horizontaloption = {
    ...
    color: ["rgb(121, 97, 245)", "rgb(227, 84, 212)"]
};
...
export const Pieoption = {
    ...
    color: ["rgb(121, 97, 245)", "rgb(227, 84, 212)", "rgb(255, 93, 159)", "rgb(254, 84, 84)", "rgb(255, 93, 159)"]
};
...
interface BubbleDataPoint extends Array<number | string> {
  0: number;  // e.g. x value
  1: number;  // e.g. y value
  2: number;  // size value for symbolSize
  3: string;  // label string (used in formatter)
}
...
export const Bubbleseries = [
    {
        ...
        emphasis: {
            ...
            label: {
                show: true,
                formatter: function (param: { data: BubbleDataPoint[]; }) {
                    return param.data[3];
                },
                position: 'top'
            }
    ...
    },
    {
        ...
        emphasis: {
            ...
            label: {
                show: true,
                formatter: function (param: { data: TooltipParam[]; }) {
                    return param.data[3];
                },
                position: 'top'
            }
