...
export const Linegardientoptions = {
  ...
  xaxis: {
    ...
    tickAmount: 10,
    labels: {
      formatter: function (_value: number, _timestamp: number, opts: { dateFormatter: (arg0: Date, arg1: string) => number; }) {
...
export const Linenulloptions = {
  ...
  colors: ["var(--primary-color)", "#e354d4", "#fab632"],
...
function getNewSeries(baseval: number, yrange: { max: number; min: number; }) {
  ...
  // Reset old data points out of range to prevent memory leaks
