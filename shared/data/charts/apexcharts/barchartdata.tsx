...
export const Barstackoptions = {
	...
	colors: ["var(--primary-color)", "#f46ef4", "#9e5cf7", "#fe5454", "#0ca3e7"],
	grid: {
		borderColor: '#f2f5f7',
	},
	title: {
...
export const Barmakeroptions = {
	...
	colors: ['#f46ef4'],
	dataLabels: {
		formatter: function (val: string, opt: { w: { config: { series: { [x: string]: { data: { [x: string]: { goals: string; }; }; }; }; }; }; seriesIndex: string | number; dataPointIndex: string | number; }) {
			const goals =
