...
export const Stackcolumnoptions = {
    ...
    colors: ["#5c67f7", "#f46ef4", "#fab632", "#fe5454"],
    responsive: [{
        breakpoint: 480,
        options: {
            legend: {
...
const colors = ['#5c67f7', '#f46ef4', '#fab632', '#0ca3e7', '#fe5454', '#0cd7b1', '#7b76fe'];
...
function updateQuarterChart(sourceChart: { w: { globals: { selectedDataPoints: number[]; }; config: { series: number[]; }; }; }, destChartIDToUpdate: string) {
    let series: number[] = [];
    const seriesIndex = 0;
    const colors: string[] = [];
...
// colors: ['#5c67f7', '#f46ef4', '#fab632', '#0ca3e7', '#fe5454', '#0cd7b1', '#7b76fe', '#fe7c58'],
