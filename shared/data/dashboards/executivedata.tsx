...
const BellIcon = (
    <svg
      ...
      viewBox="0 0 256 256"
    >
      <path d="M221.12,175.09,208,160V104a80,80,0,0,0-160,0v56L34.88,175.09A15.92,15.92,0,0,0,32,184a16,16,0,0,0,16,16H208a16,16,0,0,0,13.12-24.91ZM128,232a24,24,0,0,0,24-24H104A24,24,0,0,0,128,232ZM56,176l8-8V104a64,64,0,0,1,128,0v64l8,8Z"></path>
    </svg>
  );
...
const OpenItemsIcon = (
    <svg
      ...
      viewBox="0 0 256 256"
    >
      <path d="M224,72H130.67L104,45.33A8,8,0,0,0,98.67,43H32A16,16,0,0,0,16,59V197a15.93,15.93,0,0,0,15.84,16L224,213a16,16,0,0,0,16-16V88A16,16,0,0,0,224,72Zm0,32v93H46.34l23.41-72Z"></path>
    </svg>
);  

const ClosedItemsIcon = (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="32"
      height="32"
      ...
      viewBox="0 0 256 256"
    >
      <path d="M216,72H130.67L104,45.33A8,8,0,0,0,98.67,43H32A16,16,0,0,0,16,59V197a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V88A16,16,0,0,0,216,72ZM32,59h62.67l26.67,26.67H216V88H32Z"></path>
    </svg>
);
...
const TimerIcon = (
    <svg
      ...
      viewBox="0 0 256 256"
    >
      <path d="M136,16H120a8,8,0,0,0,0,16h16a8,8,0,0,0,0-16Zm72.49,51.51a8,8,0,0,0-11.32,0l-8.48,8.48A96,96,0,1,0,224,128a95.47,95.47,0,0,0-24.19-63.51ZM128,216a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm8-88V88a8,8,0,0,0-16,0v48a8,8,0,0,0,3.29,6.47l32,24a8,8,0,0,0,9.42-12.94Z"></path>
    </svg>
  );
...
export const DashboardCardData: DashboardCard[] = [
    { id: 1, title: 'Total Alerts', value: '15', change: '5.1%', arrow: 'up', iconBg: 'primary', icon: BellIcon, },
    { id: 2, title: 'Open Alerts', value: '5', change: '0.6%', arrow: 'up', iconBg: 'success', icon: OpenItemsIcon, },
    { id: 3, title: 'Closed Alerts', value: '10', change: '1.08%', arrow: 'down', iconBg: 'info', icon: ClosedItemsIcon, },
    { id: 4, title: 'Mean time to Notify', value: '12:05', change: '2.3%', arrow: 'up', iconBg: 'secondary', icon: TimerIcon, },
];
