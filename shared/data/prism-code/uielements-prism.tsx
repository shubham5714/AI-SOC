...
{solidalert.map((idx) => (
 <Alert variant={idx.class} className="alert-dismissible fade show" key={idx.id}>
      {idx.text}
...
{Solidalerts.map((idx, index) => (
    <SpkAlert show={alert["solid#{index}"]} variant={idx.class} key={idx.id} CustomClass={"alert-dismissible #{idx.color}"}>{idx.text}
...
{Roundedoutlinealerts.map((idx, index) => (
    <SpkAlert show={alert["round#{index}"]} variant={idx.class} key={idx.id} CustomClass="rounded-pill alert-dismissible">{idx.text}
...
{Outlinealerts.map((idx, index) => (
    ...
    <SpkAlert show={alert["outline#{index}"]} variant={idx.class} CustomClass="alert-dismissible" key={idx.id}>
        {idx.text}
...
{Shadowsolidalerts.map((idx, index) => (
    <SpkAlert show={alert["shadows#{index}"]} variant={idx.class} CustomClass={"shadow-#{idx.size} alert-dismissible"} key={idx.id}>
        {idx.text}
...
//<!-- Prism Code: This code is only used for showcode purpose -->//
    ...
    import {Defaultsolidalerts} from "@/shared/data/ui-elements/alertsdata";
     ...
     {Defaultsolidalerts.map((idx) => (
        <SpkAlert variant={idx.class} CustomClass={'shadow&#36;idx.size}'} key={idx.id}>{idx.text}</SpkAlert>
    ))}
// End Prism Code//`
...
{roundedoutlinealert.map((idx) => (
    <Alert variant={idx.class} className="alert rounded-pill alert-dismissible fade show" key={idx.id}>
        {idx.text}
        <Button variant='' type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"
...
{Roundedefaultalerts.map((idx, index) => (
    <SpkAlert show={alert["default#{index}"]} variant={idx.class} CustomClass="rounded-pill alert-dismissible" key={idx.id}>
        {idx.text}
...
{roundedwithbtnalert.map((idx) => (
    ...
    custom-rounded-alerts fade show" key={idx.id}>
        {idx.text}
...
{Roundewithbtnalerts.map((idx, index) => (
    <SpkAlert show={alert["close#{index}"]} variant={idx.class} CustomClass="rounded-pill alert-dismissible custom-rounded-alerts" key={idx.id}>
        {idx.text}
...
{customized1alert.map((idx) => (
    <Alert variant={idx.color} className={'alert alert-dismissible fade show custom-alert-icon shadow-sm svg-&#36;{idx.color}'} role="alert" key={idx.id}>
...
{Customizedalert1.map((idx,index) => (
    <SpkAlert show={alert["svg#{index}"]} variant={idx.color} CustomClass={"alert-dismissible custom-alert-icon shadow-sm svg-#{idx.color}"} key={idx.id}>
        <svg className={"me-2 svg-#{idx.color}"} xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000">
            <path d="M0 0h24v24H0z" fill="none" /><path d={idx.class1} /></svg>
        A customized {idx.color} alert with an icon
...
{imagesalert.map((idx)=>(
                <Alert variant={idx.color} className="alert alert-img alert-dismissible fase show rounded-pill flex-wrap" role="alert" key={idx.id}>
...
{avataralert.map((idx) => (
    <Alert variant={idx.color} className="alert alert-img alert-dismissible fase show flex-wrap" role="alert" key={idx.id}>
...
{Outlinebadgesdata.map((badge) => (
    <Badge key={idx.id} bg={badge.color} className={'badge bg-&#{badge.color}-transparent &#{badge.class}'}>{badge.heading}</Badge>
))} // End Prism Code//`;
...
{Outlinebadgesdata.map((badge) => (
    <SpkBadge key={idx.id} variant={badge.color} Customclass={'bg-&#{badge.color}-transparent &#{badge.class}'}>{badge.heading}</SpkBadge>
))}// End Prism Code//`;
...
{badgesdata.map((badge) => (
    <Badge key={idx.id} bg={badge.color} className={'badge bg-&#{badge.color} &#{badge.class}'}>{badge.heading}</Badge>
))} // End Prism Code//`;
...
{badges1.map((badge1) => (
    <Badge key={idx.id} className={'bg-&#{badge1.color}-gradient'}>{badge1.heading}</Badge>
))} // End Prism Code//`;
...
{badges1.map((badge1) => (
    <SpkBadge key={idx.id} Customclass={ bg-&#{badge1.color}-gradient}>{badge1.heading}</SpkBadge>
))} // End Prism Code//`;

export const reactbadge9 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
{badges1.map((badge1) => (
    <Badge key={idx.id} className={'bg-&#{badge1.color}-gradient rounded-pill'}>{badge1.heading}</Badge>
))} // End Prism Code//`;

export const reusebadge9 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
{badges1.map((badge1) => (
    <SpkBadge key={idx.id} Customclass={bg-&#{badge1.color}-gradient} Pill={true}>{badge1.heading}</SpkBadge>
))} // End Prism Code//`;
...
//<!-- Prism Code: This code is only used for showcode purpose -->//
{Outlinebadgesdata.map((badge) => (
    <Badge key={idx.id} bg={'outline-&#{badge.color}'} className={'badge outline-&#{badge.color}-transparent &#{badge.class}'}>{badge.heading}</Badge>
))} // End Prism Code//`;

export const reusebadge10 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
{Outlinebadgesdata.map((badge) => (
    <SpkBadge key={idx.id} variant={'outline-&#{badge.color}'} Customclass={badge.class}>{badge.heading}</SpkBadge>
))} // End Prism Code//`;

export const reactbadge11 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
{Outlinebadgesdata.map((badge) => (
    <Badge key={idx.id} bg={'outline-&#{badge.color}'} className={'badge outline-&#{badge.color}-transparent &#{badge.class} rounded-pill'}>{badge.heading}</Badge>
))} // End Prism Code//`;

export const reusebadge11 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
{Outlinebadgesdata.map((badge) => (
    <SpkBadge key={idx.id} variant={'outline-&#{badge.color}'} Pill={true} Customclass={badge.class}>{badge.heading}</SpkBadge>
))} // End Prism Code//`;
...
//<!-- Prism Code: This code is only used for showcode purpose -->//
{badgesdata.map((badge) => (
    <Badge key={idx.id} bg={badge.color} className={'badge bg-&#{badge.color} &#{badge.class} rounded-pill'}>{badge.heading}</Badge>
))} // End Prism Code//`;

export const reusebadge12 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
{badgesdata.map((badge) => (
    <SpkBadge key={idx.id} variant={badge.color} Pill={true} Customclass={badge.class}>{badge.heading}</SpkBadge>
))} // End Prism Code//`;
...
//<!-- Prism Code: This code is only used for showcode purpose -->//	{Outlinebadgesdata.map((badge) => (
    <Badge key={idx.id} bg={badge.color} className={'badge bg-&#{badge.color}-transparent &#{badge.class} rounded-pill'}>{badge.heading}</Badge>
))} // End Prism Code//`;

export const reusebadge13 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//	{Outlinebadgesdata.map((badge) => (
<SpkBadge key={idx.id} variant={badge.color} Pill={true} Customclass={'bg-&#{badge.color}-transparent &#{badge.class}'}>{badge.heading}</SpkBadge>
))}// End Prism Code//`;
...
{SocialIconButtons.map((idx) => (
    <Button variant={idx.class1} className="btn btn-icon btn-wave" key={idx.id}>
...
{DefaultButtons.map((idx) => (
    <Button variant={idx.class} type="button" className="rounded-pill btn-wave me-2" key={idx.id}>{idx.text}</Button>
))} // End Prism Code//`;
...
export const image1 =
    ` <Image fillclassName="rounded mx-auto d-block" 
src="../../../assets/images/media/media-55.jpg" alt="..."/> // End Prism Code//`;

export const image2 =
    ` <Image fillclassName="rounded float-end" src="../../../assets/images/media/media-54.jpg" alt="..."/> // End Prism Code//`;
...
<figure className="figure">
    <Image fillclassName="bd-placeholder-img figure-img img-fluid rounded card-img" src="../../../assets/images/media/media-56.jpg" alt="..."/>
    <figcaption className="figure-caption mt-2">A caption for the above image.
    </figcaption>
</figure>
<figure className="figure float-end">
    <Image fillclassName="bd-placeholder-img figure-img img-fluid rounded card-img" src="../../../assets/images/media/media-57.jpg" alt="..."/>
...
export const popovers1 =
    ...
    <SpkButton Buttonvariant='' Navigate="#!" Customclass="btn btn-outline-primary">Popover {idx.text}</SpkButton>
...
<Link className="me-4 svg-primary" href="#!"  >
...
<Link className="me-4 svg-secondary" href="#!" >
...
export const reusableprogress1 = `
    ...
    <SpkProgress key={idx.id} variant="primary" now={idx.data} mainClass="progress mb-3" />
))}`
...
{Stripeddata.map((idx) => (
    <SpkProgress key={idx.id} variant={idx.color} striped={true} now={idx.data} mainClass="progress mb-3" />
))}`
...
{Stripeddata.map((idx) => (
    <SpkProgress key={idx.id} variant={idx.color} label={'&#60{idx.data}%'} now={idx.data} mainClass="progress mb-3" />
))}`
...
{Multipleprogress.map((idx) => (
    <ProgressBar className={'progress-stacked progress-&#60{idx.size} mb-3'} key={idx.id}>
...
{CustomProgress2data.map((idx) => (
    <div className={'progress progress-bar progress-sm &#60{idx.class3}'} key={idx.id} >
...
export const reusableprogress12 = `
	{Animatedata.map((idx) => (
    <SpkProgress key={idx.id} variant={'&#60{idx.color}-gradient'} mainClass={'progress &#60{idx.class}'} animated={true} now={idx.data} />
))}`
...
{Animatedata.map((idx) => (
    <SpkProgress key={idx.id} variant={idx.color} mainClass={'progress &#60{idx.class}'} animated={true} now={idx.data} />
))}`
...
{Animatedata.map((idx) => (
    <SpkProgress key={idx.id} variant={'&#60{idx.color}-gradient'} mainClass={'progress progress-animate &#60{idx.class}'} animated={true} now={idx.data} />
))}`
...
export const toast1 =
    ...
    import { Toast } from "react-bootstrap";
     ...
     <Toast.Header className="text-default">
         ...
         <strong className="me-auto">Zeno</strong>
...
<SpkButton Buttontype="button" Buttonvariant="primary" Id="liveToastBtn" onClickfunc={() => addToast('live')}>Show live toast</SpkButton>
...
export const toast4 =
    ...
    <SpkToast toastClass="align-items-center text-bg-primary border-0 fade show mb-4" message="Hello, world! This is Primary toast message. " btnClass="btn-close btn-close-white me-2 m-auto" show={toasts["primary"]} onClose={() => handleToasts('primary')} ToastBtn={true} ToastHeader={false} />
                        ...
                        <SpkToast toastClass="align-items-center text-bg-info border-0 fade show mb-4" message="Hello, world! This is Info toast message. " btnClass="btn-close btn-close-white me-2 m-auto" show={toasts["info"]} onClose={() => handleToasts('info')} ToastBtn={true} ToastHeader={false} /> // End Prism Code//`;
...
export const toast10 =`<SpkButton Buttonvariant='outline-primary' Buttontype="button" onClickfunc={() => addToast('topLeft')} Customclass="me-2" Id="topleftToastBtn">Top Left</SpkButton>
...
<SpkButton Buttonvariant='outline-primary' Buttontype="button" onClickfunc={() => addToast('bottomRight')} Customclass="me-2" Id="bottomrightToastBtn">Bottom Right</SpkButton> // End Prism Code//`;
...
export const toast6 = `<div className="btn-list">
...
export const toast7 =
    `<SpkToast ToastHeader={true} onClose={() => handleToasts('transColor')} show={toasts['transColor']} toastClass="show" headerClass="text-default" imgClass="me-2" imgSrc="../../assets/images/brand-logos/toggle-logo.png" title="Zeno" timestamp="11 mins ago" message="Hello, world! This is a toast message." /> // End Prism Code//`;
...
export const tooltip3 =
    `{SVGtooltip.map((idx) => (
        <SpkTooltips key={idx.id} placement="top" overlay={<Tooltip className={'tooltip-&#{idx.color}'}>{idx.text} ">
            <Link href="#!" className="me-3 svg-primary">
...
import SpkTooltips from "@/shared/@spk-reusable-components/reusable-uielements/spk-tooltips";
 ...
 {SVGtooltip.map((idx) => (
    <SpkTooltips key={idx.id} placement="top" tooltipClass={'tooltip-&#60{idx.color}'} title={idx.text}>
        <Link href="#!" className={'me-3 svg-&#60{idx.color}'}>
...
<p><Link className="link-opacity-10-hover" href="#!"  >Link opacity 10</Link></p>
<p><Link className="link-opacity-25-hover" href="#!"  >Link opacity 25</Link></p>
<p><Link className="link-opacity-50-hover" href="#!"  >Link opacity 50</Link></p>
<p><Link className="link-opacity-75-hover" href="#!"  >Link opacity 75</Link></p>
...
export const link8 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//  <p><Link className="link-opacity-10" href="#!"  >Link opacity 10</Link></p>
...
<p className="mb-0"><Link className="link-opacity-100" href="#!"  >Link opacity 100</Link></p> // End Prism Code//`;
