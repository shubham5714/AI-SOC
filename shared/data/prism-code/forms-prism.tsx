...
return(
     <Row className="row gy-1">
                            ...
                            <Col xl={4}>
                                <div className={'toggle  00024{toggles['switch'] === 'on' || !toggles['switch'] ? 'on' : ''}'} onClick={() => toggle('switch')}>
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={toggle mb-3  toggle-secondary 00024{toggles['secondary'] === 'on' || !toggles['secondary'] ? 'on' : ''}'} onClick={() => toggle('secondary')}>
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={'toggle mb-3  toggle-warning 00024{toggles['warning'] === 'on' || !toggles['warning'] ? 'on' : ''}} onClick={() => toggle('warning')} >
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={'toggle mb-3  toggle-info 00024{toggles['info'] === 'on' || !toggles['info'] ? 'on' : ''}} onClick={() => toggle('info')}  >
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={'toggle mb-3  toggle-success 00024{toggles['success'] === 'on' || !toggles['success'] ? 'on' : ''}} onClick={() => toggle('success')} >
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={'toggle mb-3  toggle-danger 00024{toggles['danger'] === 'on' || !toggles['danger'] ? 'on' : ''}} onClick={() => toggle('danger')}>
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={'toggle mb-3  toggle-light 00024{toggles['light'] === 'on' || !toggles['light'] ? 'on' : ''}} onClick={() => toggle('light')} >
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>

                                <div className={'toggle ms-sm-2  toggle-dark 00024{toggles['dark'] === 'on' || !toggles['dark'] ? 'on' : ''}} onClick={() => toggle('dark')}>
                                    <span></span>
                                </div>
                            </Col>
                        </Row>
