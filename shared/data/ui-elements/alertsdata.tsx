...
export const Roundedoutlinealerts: alert1[] = [
	...
	{ id: 2, text: "A simple outline rounded success alert—check it out! ", class: "outline-success" },
	{ id: 3, text: "A simple outline rounded info alert—check it out! ", class: "outline-info" },
	{ id: 4, text: "A simple outline rounded secondary alert—check it out!", class: "outline-secondary" },
	{ id: 5, text: "A simple outline rounded warning alert—check it out! ", class: "outline-warning" },
	{ id: 6, text: "A simple outline rounded danger alert—check it out! ", class: "outline-danger" },
];

export const Roundedoutlinealerts1: alert1[] = [
	{ id: 1, text: "A simple solid rounded primary alert—check it out! ", class: "solid-primary" },
	{ id: 5, text: "A simple solid rounded secondary alert—check it out! ", class: "solid-secondary" },
	{ id: 6, text: "A simple solid rounded warning alert—check it out! ", class: "solid-warning" },
	{ id: 7, text: "A simple solid rounded danger alert—check it out!", class: "solid-danger" }
...
export const Roundedefaultalerts: alert1[] = [
	...
	{ id: 2, text: "A simple rounded success alert—check it out! ", class: "success" },
	{ id: 3, text: "A simple rounded info alert—check it out! ", class: "info" },
	{ id: 4, text: "A simple rounded secondary alert—check it out!", class: "secondary" },
	{ id: 5, text: "A simple rounded warning alert—check it out! ", class: "warning" },
	{ id: 6, text: "A simple rounded danger alert—check it out!", class: "danger" },
];
...
export const Svgalert = [
	...
	{ id: 3, class1: Asvg2, text1: "Warning Alert", text2: "Warning alert to show warning message", color: "info", btn1: "cancel", btn2: "open", class: "dark" },
...
export const Additionalcontentalerts: alert10[] = [
	...
	{ id: 2, text1: "Thank you for reporting this.", text2: "We appreciate you to let us know the bug in the template and for warning us about future consequences ", text3: "Visit for support for queries ?", class: "success" },
	{ id: 3, text1: "Thank you for reporting this.", text2: "We appreciate you to let us know the bug in the template and for warning us about future consequences ", text3: "Visit for support for queries ?", class: "info" },
	{ id: 4, text1: "Thank you for reporting this.", text2: "We appreciate you to let us know the bug in the template and for warning us about future consequences ", text3: "Visit for support for queries ?", class: "secondary" }
];
