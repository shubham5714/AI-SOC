...
import { DashboardCardData, OrderStatusOptions, OrderStatusSeries, RecentActivity, RecentOrders, SellingProducts, TotalOrdersOptions, TotalOrdersSeries } from "@/shared/data/dashboards/ecommercedata";
...
const Ecommerce: React.FC<EcommerceProps> = () => {
    ...
    // Use user context
    const { userData, isLoading: userLoading, isAuthenticated } = useUserContext();
    ...
    if (!isAuthenticated) {
        return null; // Will redirect to login via UserContext
    }
