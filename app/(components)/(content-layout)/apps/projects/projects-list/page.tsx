...
const ProjectsList: React.FC<ProjectsListProps> = () => {
    ...
    const Projectlist: ProjectListType[] = ProjectList.filter(project =>
                        ...
                        <Card.Body className="p-3">
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1 project-list-main align-items-center">
                                    <Link scroll={false} href="/apps/projects/create-project" className="btn btn-primary me-2"><i className="ri-add-line me-1 fw-medium align-middle"></i>New Project</Link>
                                ...
                                <div className="d-flex" role="search">
                                    <Form.Control className="me-2" type="search" placeholder="Search Project" aria-label="Search" value={searchTerm} onChange={handleSearch} />
