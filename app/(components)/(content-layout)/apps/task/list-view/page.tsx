...
import { TasksViewsData, TaskCardStat, Status, Priority, tags, TaskType } from "@/shared/data/apps/task/list-view-data";
...
const TaskListview: React.FC<TaskListviewProps> = () => {
    const [listView, setListView] = useState<TaskType[]>(TasksViewsData);
