...
import { Ecommerceproducts, ProductProps } from "@/shared/data/apps/executive/reduxdata";
...
const Wishlist: React.FC<WishlistProps> = () => {
    ...
    return (
        <Fragment>
            <Seo title="Wishlist" />
            <Pageheader title="Apps" subtitle="Executive" currentpage="Wishlist" activepage="Wishlist" />
