...
import LabeledTwoThumbs1 from "@/shared/data/apps/executive/ordersdata";
import { ProductProps } from "@/shared/data/apps/executive/reduxdata";
...
const Products: React.FC<ProductsProps> = () => {
    ...
    return (
        <Fragment>
            <Seo title="Products" />
            <Pageheader title='Apps' subtitle='Executive' currentpage='Products' activepage='Products' />
            {/* <!-- Start:: Row-1 --> */}
            <Row className="">
                <Col xl={12} className="">
