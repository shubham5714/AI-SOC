...
import { Ordertable } from "@/shared/data/apps/executive/ordersdata";
...
const Orders: React.FC<OrdersProps> = () => {
    ...
    return (
        <Fragment>
            <Seo title="Orders" />
            <Pageheader title='Apps' subtitle='Executive' currentpage='Orders' activepage='Orders' />
            {/* <!-- Start::row-1 --> */}
                                ...
                                <tr className="order-list" key={idx.id}>
                                    ...
                                    <td>
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ms-2">
                                                <p className="fw-medium mb-0 d-flex align-items-center"><Link href="/apps/executive/order-details">{idx.product}</Link></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <Link href="/apps/executive/order-details" className="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light me-1">
