...
import { dataType, ProductList } from "@/shared/data/apps/executive/productlistdata";
...
const ProductsList: React.FC<ProductsListProps> = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader title='Apps' subtitle='Executive' currentpage='Products List' activepage='Products List' />
            {/* <!-- Start::row-1 --> */}
            <Row>
                <Col xl={12}>
                                        ...
                                        <tr key={product.id} className="product-list">
                                            ...
                                            <td>
                                                <div className="hstack gap-2 fs-15">
                                                    <Link scroll={false} href="/apps/executive/edit-products/" className="btn btn-icon btn-sm btn-primary-light">
