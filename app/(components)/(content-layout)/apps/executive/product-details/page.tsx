...
import { RatingsSwiper, RelatedSwiper, Slides } from "@/shared/data/apps/executive/productdetailsdata";
...
const ProductsDetails: React.FC<ProductsDetailsProps> = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader title='Apps' subtitle='Executive' currentpage='Products Details' activepage='Products Details' />
            {/* <!-- Start:: Row-1 --> */}
            <Row className="">
                <Col xxl={4} className="">
                        ...
                        <Card.Body className=" p-4">
                            <div>
                                ...
                                <div className="d-flex gap-2 flex-wrap mb-4">
                                    <Link href="/apps/executive/wishlist/" className="btn btn-primary-ghost"><i className="ri-heart-2-line me-2"></i>Add To Favourites</Link>
                                    <div className="fs-14">
                    ...
                    <Card className="set-order-card custom-card">
                        ...
                        <Card.Body className="px-0 pt-0">
                            ...
                            <div className="d-grid mt-3 px-3">
                                <Link href="/apps/executive/cart/" className="btn btn-primary m-1">Add To Cart</Link>
                                <Link href="/apps/executive/checkout/" className="btn btn-outline-primary m-1">Buy Now</Link>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
