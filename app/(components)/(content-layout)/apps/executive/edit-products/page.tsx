...
import { Availableedit, Brandedit, Categoryedit, Coloredit, Genderedit, Publishedit, Sizeedit, Tagsedit } from "@/shared/data/apps/executive/editproductsdata";
...
const EditProducts: React.FC<EditProductsProps> = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader title='Apps' subtitle='Executive' currentpage='Edit Products' activepage='Edit Products' />
            {/* <!-- Start::row-1 --> */}
            <Row>
                <Col xl={12}>
