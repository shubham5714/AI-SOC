...
const Checkout: React.FC<CheckoutProps> = () => {
    ...
    return (
        <Fragment>
            <Seo title="Checkout" />
            <Pageheader title='Apps' subtitle='Executive' currentpage='Checkout' activepage='Checkout' />
            {/* <!-- Start:: Row-1 --> */}
            <Row className="">
                <Col xxl={9}>
                                ...
                                <Tab.Content className="border border-dashed" id="myTabContent">
                                    ...
                                    <Tab.Pane eventKey="fourth" className="fade border-0 p-0" id="delivery-tab-pane" role="tabpanel"
                                        ...
                                        <div className="p-3 checkout-payment-success my-3">
                                            ...
                                            <Link scroll={false} href="/apps/executive/products" className="btn btn-primary">Continue Shopping<i className="bi bi-cart ms-2"></i></Link>
                                        </div>
                                    </Tab.Pane>
                                </Tab.Content>
                            </Tab.Container>
