...
import { Ecommerceproducts } from "@/shared/data/apps/executive/reduxdata";
...
const Cart: React.FC<CartProps> = () => {
    ...
    return (
        <Fragment>
            <Seo title="Cart" />
            <Pageheader title='Apps' subtitle='Executive' currentpage='Cart' activepage='Cart' />
            {/* <!-- Start:: Row-1 --> */}
            <Row className="">
                <Col xl={9} className="">
                    {isEmpty ? (
                        <Card className=" custom-card " id="cart-empty-cart">
                            ...
                            <Card.Body className="">
                                <div className="cart-empty text-center">
                                    ...
                                    <Link scroll={false} href="/apps/executive/products" className="btn btn-primary btn-wave m-3" data-abc="true">continue shopping <i className="bi bi-arrow-right ms-1"></i></Link>
                                </div>
                            </Card.Body>
                        </Card>
                    ) : (
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <SpkTooltips placement="top" title="Add To Wishlist">
                                                        <Link scroll={false} href="/apps/executive/wishlist" onClick={() => handleAddToWishlist(product)} className="btn btn-icon btn-primary-light btn-sm me-1"><i className="ri-heart-line"></i></Link>
                                                    </SpkTooltips>
                    ...
                    <Card className=" custom-card">
                        ...
                        <Card.Body className=" p-0">
                            ...
                            <div className="p-3 d-grid">
                                <Link scroll={false} href="/apps/executive/checkout" className="btn btn-primary btn-wave mb-2">Proceed To Checkout</Link>
                                <Link scroll={false} href="/apps/executive/products" className="btn btn-light btn-wave">Continue Shopping</Link>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
