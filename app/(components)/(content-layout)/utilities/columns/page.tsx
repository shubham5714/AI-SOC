                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body className="bd-example-row">
                                    ...
                                    <p>There are also responsive <span className="text-danger">.order-first</span> and
                                        <span className="text-danger">.order-last</span> classes that change the order of an element by applying <span className="text-danger">order: -1</span>  and <span className="text-danger">order: 6</span>, respectively. These
                    ...
                    <Card className="custom-card">
                        <Card.Body className="">
                            ...
                            <div className="clearfix">
                                <Image width={378} height={242} src="../../assets/images/media/media-40.jpg" className="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="..." />
                                <p>
