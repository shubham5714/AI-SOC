                        ...
                        <Form>
                            <Row className="gy-4">
                                ...
                                <Col xl={6} lg={6} md={6} sm={12}>
                                    ...
                                    <Form.Control type="text" id="input-text" placeholder="Text" autoComplete="username" />
                                </Col>
                                <Col xl={6} lg={6} md={6} sm={12}>
                                ...
                                <Col xl={6} lg={6} md={6} sm={12}>
                                    ...
                                    <Form.Control type="password" id="input-password" placeholder="Password" autoComplete="current-password" />
                                </Col>
                                <Col xl={6} lg={6} md={6} sm={12}>
                    ...
                    <ShowCode title="Overview" customCardClass="custom-card" customCardBodyClass="" reactCode={input5}>
                        <Form>
                            <div className="mb-3">
                                ...
                                <Form.Control type="email" id="exampleInputEmail1/" autoComplete="current-password" aria-describedby="emailHelp" />
                            ...
                            <div className="mb-3">
                                ...
                                <Form.Control type="password" id="exampleInputPassword1" autoComplete="current-password" />
                            </div>
                            <div className="mb-3">
                        ...
                        <Col xl={12}>
                            <ShowCode title="Form text" customCardClass="custom-card" customCardBodyClass="" reactCode={input6}>
                                <Form>
                                    ...
                                    <Form.Control type="password" id="inputPassword5" className="form-control/" autoComplete="" aria-describedby="passwordHelpBlock" />
                                </Form>
                                ...
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-auto">
                                        <Form.Control type="password" id="inputPassword6"
                                            autoComplete="new-password1" aria-describedby="passwordHelpInline" />
                                    </div>
                                    <div className="col-auto">
