                    ...
                    <ShowCode title="Vertical Forms" customCardClass="custom-card" customCardBodyClass="" reactCode={layout1}>
                        <Form>
                            <div className="mb-3">
                                ...
                                <Form.Control type="text" className="" id="form-text" placeholder="Full name" autoComplete="username"/>
                            </div>
                            <div className="mb-3">
                                <Form.Label htmlFor="form-password" className="fs-14 text-dark">Enter  Password</Form.Label>
                                <Form.Control type="password" className="" id="form-password" placeholder="password" autoComplete="current-password" />
                            </div>
                    ...
                    <ShowCode title="Horizontal form" customCardClass="custom-card" customCardBodyClass="" reactCode={layout2}>
                        <Form>
                            <div className="row mb-3">
                                ...
                                <Col sm={10}>
                                    <Form.Control type="email" className="form-control" id="inputEmail3" autoComplete="username" />
                                </Col>
                            </div>
                            <div className="row mb-3">
                                <Form.Label htmlFor="inputPassword3" className="col-sm-2 col-form-label fs-14">Password</Form.Label>
                                <Col sm={10}>
                                    <Form.Control type="password" className="form-control" id="inputPassword3" autoComplete="current-password" />
                                </Col>
                            </div>
                        ...
                        <Form>
                            <div className="mb-3">
                                ...
                                <InputGroup>
                                    ...
                                    <Form.Control type="text" className="" id="form-text1" placeholder="" autoComplete="username"/>
                                </InputGroup>
                            </div>
                            <div className="mb-3">
                                ...
                                <InputGroup>
                                    ...
                                    <Form.Control type="password" className="" id="form-password1" placeholder="" autoComplete="current-password"/>
                                </InputGroup>
                            </div>
                    ...
                    <ShowCode title="Horizontal form With Icons" customCardClass="custom-card" customCardBodyClass="" reactCode={layout8}>
                        <Form>
                            <Row className="mb-3">
                                ...
                                <Col sm={10}>
                                    <InputGroup>
                                        <Form.Control type="email" className="form-control" id="inputEmail1" autoComplete="username" />
                            ...
                            <Row className="row mb-3">
                                ...
                                <Col sm={10}>
                                    <InputGroup>
                                        <Form.Control type="password" className="form-control" id="inputPassword1" autoComplete="current-password" />
                                        <InputGroup.Text className="input-group-text">
                    ...
                    <ShowCode title="Auto sizing" customCardClass="custom-card" customCardBodyClass="" reactCode={layout9}>
                        <Form className="row gy-2 gx-3 align-items-center mb-4">
                            <Col xs="auto">
                                ...
                                <Form.Control className="" id="inlineFormInput" placeholder="Jane Doe" />
                            </Col>
                            <Col xs="auto">
                            ...
                            <Col xs="auto">
                                <SpkButton Buttontype="submit" Customclass="">
                                    Submit
                                </SpkButton>
                            </Col>
                        </Form>
                    ...
                    <ShowCode title="Gutters" customCardClass="custom-card" customCardBodyClass="" reactCode={layout11}>
                        <Form className="row g-3 mt-0">
                            ...
                            <Col md={6}>
                                ...
                                <Form.Control type="email" className="" id="inputEmail4" placeholder="Email id" autoComplete="username" />
                            </Col>
                            <Col md={6}>
                                <Form.Label htmlFor="inputPassword4" className="">Password</Form.Label>
                                <Form.Control type="password" className="" id="inputPassword4" autoComplete="current-password" placeholder="Password" />
                            </Col>
                            <div className="col-12">
